...
class AppMenu
{
    ...
    private static function definitions(callable $entry): array
    {
        ...
        return [
            ...
            $entry(['group' => 'Rawat Jalan', 'groupOrder' => 5, 'order' => 4, 'route' => 'jadwal-kontrol', 'title' => 'Jadwal Kontrol Pasien', 'desc' => 'Lihat & geser tanggal rencana kontrol (SKDP) RJ/RI — update otomatis ke BPJS', 'roles' => ['admin', 'mr', 'tu', 'supervisor tu', 'manager umum'], 'badge' => 'SKDP']),
            ...
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 7, 'route' => 'panduan-dev', 'title' => 'Standarisasi UI', 'desc' => 'Acuan design system internal — warna, tipografi & komponen', 'roles' => ['admin'], 'badge' => 'UI']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 8, 'route' => 'panduan-dev.koding-master', 'title' => 'Tutorial Koding Master', 'desc' => 'Panduan membangun modul master (2-file, event, LOV, CRUD)', 'roles' => ['admin'], 'badge' => 'DOC']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 9, 'route' => 'panduan-dev.koding-transaksi', 'title' => 'Tutorial Koding Transaksi', 'desc' => 'Pola modul transaksi RJ/UGD/RI — JSON CLOB, EMR, dokumen, administrasi', 'roles' => ['admin'], 'badge' => 'DOC']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 10, 'route' => 'panduan-dev.koding-satusehat', 'title' => 'Tutorial Koding SATUSEHAT', 'desc' => 'Kirim data FHIR R4 ke SATUSEHAT — resource, kode, checklist kolom wajib', 'roles' => ['admin'], 'badge' => 'DOC']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 11, 'route' => 'panduan-dev.koding-administrasi', 'title' => 'Tutorial Koding Administrasi', 'desc' => 'Konsep administrasi/kasir RJ/UGD/RI sampai pulang + transfer & model batal', 'roles' => ['admin'], 'badge' => 'DOC']),
            $entry(['group' => 'Sistem', 'groupOrder' => 14, 'order' => 12, 'route' => 'panduan-dev.koding-skill', 'title' => 'Katalog Skill', 'desc' => 'Daftar skill repo (.claude/skills/*) + kapan dibaca', 'roles' => ['admin'], 'badge' => 'DOC']),
        ];
    }
}
