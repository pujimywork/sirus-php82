...
@php
    ...
    // Samakan dengan <x-text-input> (bg-gray-50 + text-gray-900 + rounded-lg) supaya konsisten.
    $baseClass = 'bg-gray-50 border-gray-300 text-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100
        ...
        rounded-lg shadow-sm disabled:opacity-90 disabled:bg-gray-100 disabled:cursor-not-allowed w-full tabular-nums text-right';
