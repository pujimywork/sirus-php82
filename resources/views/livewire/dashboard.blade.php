...
new class extends Component {
    ...
    public function masterMenus(): array
    {
        ...
        $rows = array_filter([
            ...
            $entry(['group' => 'Casemix', 'groupOrder' => 8, 'order' => 1, 'route' => 'rawat-jalan.daftar-bulanan', 'title' => 'Daftar Pasien Bulanan RJ',  'desc' => 'List pasien rawat jalan per bulan (mm/yyyy)',     'roles' => ['admin', 'manager umum', 'casemix', 'tu'], 'badge' => 'RJ-BLN']),
            $entry(['group' => 'Casemix', 'groupOrder' => 8, 'order' => 2, 'route' => 'ugd.daftar-bulanan',         'title' => 'Daftar Pasien Bulanan UGD', 'desc' => 'List pasien UGD per bulan (mm/yyyy)',             'roles' => ['admin', 'manager umum', 'casemix', 'tu'], 'badge' => 'UGD-BLN']),
            $entry(['group' => 'Casemix', 'groupOrder' => 8, 'order' => 3, 'route' => 'ri.daftar-bulanan',          'title' => 'Daftar Pasien Bulanan RI',  'desc' => 'List pasien RI per bulan berdasarkan tgl pulang', 'roles' => ['admin', 'manager umum', 'casemix', 'tu'], 'badge' => 'RI-BLN']),

            // ── Apotek (transaksi) ────────────────────────────────────
            $entry(['group' => 'Apotek', 'groupOrder' => 9, 'order' => 1, 'route' => 'transaksi.apotek',                       'title' => 'Antrian Apotek',     'desc' => 'Telaah resep & pelayanan kefarmasian — tab RJ, UGD, RI', 'roles' => ['admin', 'apoteker'], 'badge' => 'APT']),
            $entry(['group' => 'Apotek', 'groupOrder' => 9, 'order' => 2, 'route' => 'transaksi.rj.antrian-apotek-rj',        'title' => 'Antrian Apotek RJ', 'desc' => 'Antrian apotek khusus pasien rawat jalan',                'roles' => ['admin', 'apoteker'], 'badge' => 'APT-RJ']),
            $entry(['group' => 'Apotek', 'groupOrder' => 9, 'order' => 3, 'route' => 'transaksi.ugd.antrian-apotek-ugd',      'title' => 'Antrian Apotek UGD','desc' => 'Antrian apotek khusus pasien UGD',                        'roles' => ['admin', 'apoteker'], 'badge' => 'APT-UGD']),
            ...
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 2, 'route' => 'gudang.penerimaan-non-medis', 'title' => 'Barang dari Supplier (Non-Medis)', 'desc' => 'Penerimaan barang non-medis dari supplier',           'roles' => ['admin', 'tu'],     'badge' => 'RCV-N']),
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 3, 'route' => 'gudang.transfer-stock',      'title' => 'Transfer Stok Medis',      'desc' => 'Pindahkan obat antar lokasi — sumber dari Gudang Medis atau Apotek',                  'roles' => ['admin', 'apoteker'], 'badge' => 'TRF']),
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 4, 'route' => 'gudang.transfer-stock-non',  'title' => 'Transfer Stok Non-Medis',   'desc' => 'Pindahkan barang non-medis (ATK, RT, dll.) dari Gudang Non-Medis',                       'roles' => ['admin', 'tu'],        'badge' => 'TRF-N']),
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 5, 'route' => 'gudang.kartu-stock',          'title' => 'Kartu Stock — Gudang Medis', 'desc' => 'Riwayat mutasi stok per produk — Gudang Medis',     'roles' => ['admin', 'apoteker'], 'badge' => 'STK']),
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 6, 'route' => 'gudang.kartu-stock-apt',      'title' => 'Kartu Stock — Apotek',       'desc' => 'Riwayat mutasi stok per produk — Apotek',           'roles' => ['admin', 'apoteker'], 'badge' => 'STK-A']),
            $entry(['group' => 'Gudang', 'groupOrder' => 11, 'order' => 7, 'route' => 'gudang.kartu-stock-non',      'title' => 'Kartu Stock — Non-Medis',    'desc' => 'Riwayat mutasi stok per produk — Gudang Non-Medis', 'roles' => ['admin', 'tu'],     'badge' => 'STK-N']),

            // ── Keuangan ──────────────────────────────────────────────
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 1,  'route' => 'keuangan.penerimaan-kas-tu',           'title' => 'Penerimaan Kas TU',                'desc' => 'Catat penerimaan kas di luar transaksi pelayanan RS',                                  'roles' => ['admin', 'tu'], 'badge' => 'CI']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 2,  'route' => 'keuangan.pengeluaran-kas-tu',          'title' => 'Pengeluaran Kas TU',               'desc' => 'Catat pengeluaran kas di luar transaksi pelayanan RS',                                 'roles' => ['admin', 'tu'], 'badge' => 'CO']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 3,  'route' => 'keuangan.pembayaran-hutang-pbf',       'title' => 'Pembayaran Hutang PBF',            'desc' => 'Pelunasan / angsuran hutang ke supplier obat (PBF)',                                   'roles' => ['admin', 'tu'], 'badge' => 'HTG']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 4,  'route' => 'keuangan.pembayaran-hutang-non-medis', 'title' => 'Pembayaran Hutang Non-Medis',      'desc' => 'Pelunasan / angsuran hutang ke supplier non-medis',                                    'roles' => ['admin', 'tu'], 'badge' => 'HTG-N']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 5,  'route' => 'keuangan.topup-supplier-pbf',          'title' => 'Setor DP Supplier PBF',            'desc' => 'Setor uang muka / DP ke supplier obat (PBF)',                                          'roles' => ['admin', 'tu'], 'badge' => 'DP']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 6,  'route' => 'keuangan.topup-supplier-non-medis',    'title' => 'Setor DP Supplier Non-Medis',      'desc' => 'Setor uang muka / DP ke supplier non-medis',                                           'roles' => ['admin', 'tu'], 'badge' => 'DP-N']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 7,  'route' => 'keuangan.saldo-kas',                   'title' => 'Saldo Kas',                        'desc' => 'Posisi saldo kas/bank per tanggal — riwayat transaksi & edit saldo awal tahun (admin)','roles' => ['admin', 'tu'], 'badge' => 'SK']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 8,  'route' => 'keuangan.buku-besar',                  'title' => 'Buku Besar',                       'desc' => 'Mutasi & saldo per akun dalam periode tertentu',                                       'roles' => ['admin', 'tu'], 'badge' => 'BB']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 9,  'route' => 'keuangan.laba-rugi',                   'title' => 'Laporan Laba Rugi',                'desc' => 'Pendapatan vs beban — laba/rugi periode berjalan',                                     'roles' => ['admin', 'tu'], 'badge' => 'LR']),
            $entry(['group' => 'Keuangan', 'groupOrder' => 12, 'order' => 10, 'route' => 'keuangan.neraca',                      'title' => 'Laporan Neraca',                   'desc' => 'Posisi aktiva, kewajiban & modal per tanggal',                                         'roles' => ['admin', 'tu'], 'badge' => 'NRC']),
