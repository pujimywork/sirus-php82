...
new class extends Component {
    ...
    {
        $this->reset(['accdocId', 'accdocDesc', 'accdocPrice', 'accdocPriceBpjs', 'activeStatus', 'paketLainLain', 'paketObat', 'formPaketLain', 'formPaketObat']);
        $this->activeStatus = '1';
...
<div>
    <x-modal name="master-jasa-dokter-actions" size="full" height="full" focusable>
        <x-dirty-modal-content
            ...
            {{-- BODY --}}
            <div class="flex-1 px-4 py-4 bg-surface-soft dark:bg-gray-950/20 space-y-4" x-enter-chain>
