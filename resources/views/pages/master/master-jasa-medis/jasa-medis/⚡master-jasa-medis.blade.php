            ...
            <div class="lg:col-span-7 flex flex-col min-h-0 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
                <div class="flex-1 min-h-0 overflow-x-auto overflow-y-auto rounded-t-2xl">
                    <table class="min-w-full text-sm border-separate border-spacing-y-2">
                        ...
                        <tbody class="text-gray-500 dark:text-gray-400 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($this->rows as $row)
                                ...
                                <tr wire:key="jm-row-{{ $row->pact_id }}"
                                    ...
                                    <td class="px-6 py-4 font-mono text-sm text-gray-600 dark:text-gray-300">{{ $row->pact_id }}</td>
                                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">{{ $row->pact_desc }}</td>
                                ...
                                @if ($isExpanded)
                                    ...
                                    @endphp
                                    <tr wire:key="jm-paket-{{ $row->pact_id }}" class="rounded-2xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 bg-gray-50/60 dark:bg-gray-800/30">
                ...
                <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50/60 dark:bg-gray-800/40 rounded-t-2xl">
                    ...
                    @if ($selectedPactId)
                        <div class="mt-1 flex items-center gap-2 text-xs">
                            <span class="px-1.5 py-0.5 rounded font-mono font-bold bg-gray-200/70 dark:bg-gray-700/60 text-gray-700 dark:text-gray-200">{{ $selectedPactId }}</span>
