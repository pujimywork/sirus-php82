<?php
// resources/views/pages/components/modul-dokumen/u-g-d/penundaan-pelayanan/cetak-penundaan-pelayanan.blade.php
...
new class extends Component {
    ...
    #[On('cetak-penundaan-pelayanan-ugd.open')]
    public function open(int $rjNo, ?string $signatureDate = null): mixed
    {
        ...
        $list = $dataUGD['penundaanPelayananUGD'] ?? [];
        if (empty($list)) {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.u-g-d.penundaan-pelayanan.cetak-penundaan-pelayanan-print', ['data' => $data])->setPaper('A4');

        return response()->streamDownload(fn() => print $pdf->output(), 'penundaan-pelayanan-ugd-' . ($pasien['regNo'] ?? $rjNo) . '.pdf');
    }
};
?>
<div></div>
