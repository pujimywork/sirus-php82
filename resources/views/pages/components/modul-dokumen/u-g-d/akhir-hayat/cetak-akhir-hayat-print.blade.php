...
<x-pdf.layout-a4-with-out-background title="PENGKAJIAN AKHIR HAYAT">
    ...
    <table class="ah">
        ...
        <tr>
            ...
            <td>
                {{ $yaTidak(data_get($form, 'spiritual.perluPelayanan')) }}@if (data_get($form, 'spiritual.perluPelayanan') === 'ya')@if (filled(data_get($form, 'spiritual.agama'))) — agama: {{ data_get($form, 'spiritual.agama') }}@endif @if (filled(data_get($form, 'spiritual.oleh'))) — oleh: {{ data_get($form, 'spiritual.oleh') }}@endif @if ($spiritualBentuk) ; bentuk: {{ $spiritualBentuk }}@endif @endif
            </td>
        </tr>
        <tr>
