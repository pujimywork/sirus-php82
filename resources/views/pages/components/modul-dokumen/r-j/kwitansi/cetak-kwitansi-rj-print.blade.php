...
<x-pdf.layout-kwitansi :title="$data['judul'] ?? 'KWITANSI PEMBAYARAN - Rawat Jalan'">
    ...
    <x-pdf.identitas-pasien
        ...
        <tr>
            <td class="py-0.5 text-[11px] text-gray-500 whitespace-nowrap">Tgl. Rawat Jalan</td>
            <td class="py-0.5 text-[11px] px-1">:</td>
    ...
    <table class="w-full mb-1 text-[11px]" cellpadding="0" cellspacing="0">
        ...
        <tfoot>
            ...
            {{-- <tr class="border-t border-gray-200">
                <td colspan="2" class="pt-1 pb-0.5 text-right pr-3 text-gray-700">Pembayaran</td>
                <td class="pt-1 pb-0.5 text-right tabular-nums text-gray-900">
            ...
            {{-- Sisa --}}
            {{-- <tr>
                <td colspan="2" class="pb-1 text-right pr-3 text-gray-700">Sisa</td>
                <td class="pb-1 text-right tabular-nums text-gray-900">
    ...
    {{-- Terbilang — dari grandTotal (total yang harus dibayar) --}}
