<x-pdf.layout-a4-with-out-background title="RESEP RAWAT INAP">
    ...
    <x-slot name="patientData">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="py-0.5 text-[11px] text-gray-500 whitespace-nowrap">No. SLS / Tanggal</td>
            ...
            <tr>
                <td class="py-0.5 text-[11px] text-gray-500 whitespace-nowrap">Klaim / Ruangan</td>
                <td class="py-0.5 text-[11px] px-1">:</td>
            ...
            <td class="w-1/2 align-top" style="padding-right:12px;">
                ...
                @isset($dataDaftarPoliRJ['eresep'])
                    <table class="w-full mb-3" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($dataDaftarPoliRJ['eresep'] as $eresep)
                ...
                @isset($dataDaftarPoliRJ['eresepRacikan'])
                    ...
                    <table class="w-full" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($dataDaftarPoliRJ['eresepRacikan'] as $eresep)
        ...
        <tr>
            ...
            <td class="w-1/4 text-center align-top">
                <p class="text-gray-700">
                    Tulungagung, {{ $dataDaftarPoliRJ['rjDate'] ?? \Carbon\Carbon::now()->translatedFormat('d F Y') }}
                </p>
                <p class="mb-1 text-gray-700">Dokter Pemeriksa</p>
                @php
                    $drId = $dataDaftarPoliRJ['drId'] ?? null;
                ...
                <div class="inline-block pt-1 border-t border-gray-400" style="min-width:120px;">
                    <span class="text-gray-900">
                        {{ $dataDaftarPoliRJ['perencanaan']['pengkajianMedis']['drPemeriksa'] ?? ($dokter->dr_name ?? 'Dokter Pemeriksa') }}
                    </span>
                </div>
            ...
            <td class="w-1/4 text-center align-top">
                ...
                @php
                    $trCode = $dataDaftarPoliRJ['telaahResep']['penanggungJawab']['userLogCode'] ?? null;
                ...
                <div class="inline-block pt-1 border-t border-gray-400" style="min-width:120px;">
                    <span class="text-gray-900">
                        {{ $dataDaftarPoliRJ['telaahResep']['penanggungJawab']['userLog'] ?? 'Pengkajian Resep' }}
                    </span>
                </div>
            </td>
            ...
            <td class="w-1/4 text-center align-top">
                ...
                @php
                    $toCode = $dataDaftarPoliRJ['telaahObat']['penanggungJawab']['userLogCode'] ?? null;
                ...
                <div class="inline-block pt-1 border-t border-gray-400" style="min-width:120px;">
                    <span class="text-gray-900">
                        {{ $dataDaftarPoliRJ['telaahObat']['penanggungJawab']['userLog'] ?? 'Pengkajian Obat' }}
                    </span>
                </div>
            </td>
