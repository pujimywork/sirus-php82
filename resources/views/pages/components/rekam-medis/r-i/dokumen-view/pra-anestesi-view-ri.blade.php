<?php
// Viewer read-only "Pra-Anestesi" — display Rekam Medis RI.
...
new class extends Component {
    ...
    private string $printView = 'pra-anestesi-ri.cetak-pra-anestesi-ri-print';
    private string $filePrefix = 'pra-anestesi-ri';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-pra-anestesi-ri-{$this->riHdrNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pra-anestesi-ri-{{ $riHdrNo }}" title="Pra-Anestesi"
