        ...
        <div class="px-6 pt-4 pb-6 space-y-4">
            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">1. Pilih Supplier (Non-Medis)</h3>
                        ...
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="text-gray-700 divide-y divide-gray-200 dark:divide-gray-700 dark:text-gray-200">
                                @forelse($this->history as $row)
                                    <tr wire:key="topup-non-medis-{{ $row->cashout_no ?? $loop->index }}" class="hover:bg-gray-50 dark:hover:bg-gray-800/60">
