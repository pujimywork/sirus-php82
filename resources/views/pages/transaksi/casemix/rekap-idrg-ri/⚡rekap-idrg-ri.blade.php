        ...
        <div class="flex flex-col flex-1 min-h-0 px-6 pt-2 pb-6">
            ...
            <div class="mt-4 flex flex-col flex-1 min-h-0 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
                ...
                <div class="flex flex-wrap gap-6 px-6 py-3 text-sm border-b border-gray-200 dark:border-gray-700">
                    <span class="text-gray-600 dark:text-gray-300">Pasien (hal. ini): <b>{{ count($this->rows) }}</b></span>
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($this->rows as $row)
                                ...
                                <tr class="transition hover:bg-green-50 dark:hover:bg-gray-800/50" wire:key="rekap-{{ $row->rihdr_no }}">
                                    @if ($c && ($c['status'] ?? '') === 'ok')
                                    ...
                                    @else
                                        ...
                                        <td class="px-4 py-3 text-gray-400" colspan="6">
                                            @if ($c && ($c['status'] ?? '') === 'error')
