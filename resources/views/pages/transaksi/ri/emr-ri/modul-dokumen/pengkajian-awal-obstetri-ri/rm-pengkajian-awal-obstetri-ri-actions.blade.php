...
// Pola sama dgn Laporan Operasi (modul dokumen RI): multi-entri, simpan ke datadaftarri_json.
...
new class extends Component {
    ...
    public array $newForm = [
        ...
        // 13. Tanda Tangan (auto-stamp dari user login via tombol "TTD Saya")
    ...
    public function addEntry(): void
    {
        ...
        try {
            DB::transaction(function () use ($entry) {
                ...
                $this->appendAdminLogRI((int) $this->riHdrNo, 'Tambah Pengkajian Awal Obstetri — ' . ($entry['ttd'] ?? '-') . ' — ' . $entry['createdAt'], 'MR');
            });

            $this->incrementVersion('modal-pengkajian-awal-obstetri-ri');
            $this->dispatch('toast', type: 'success', message: 'Pengkajian awal obstetri berhasil disimpan.');
            $this->resetNewForm();
                    ...
                    <fieldset @disabled($isFormLocked) class="space-y-4">
                        ...
                        <x-border-form title="5. Status Obstetri & KB">
                            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div><x-input-label value="HPL / TP" /><div class="flex gap-1 mt-1"><x-text-input type="date" wire:model="newForm.hpl" class="w-full" /><x-now-button wire:click="setTglSekarang('hpl')" /></div></div>
                        ...
                        <x-border-form title="6. Riwayat Persalinan Sekarang">
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                                    <div><x-input-label value="His mulai — Tgl" /><div class="flex gap-1 mt-1"><x-text-input type="date" wire:model="newForm.hisMulaiTgl" class="w-full" /><x-now-button wire:click="setTglSekarang('hisMulaiTgl')" /></div></div>
                                    <div><x-input-label value="Jam" /><div class="flex gap-1 mt-1"><x-text-input type="time" wire:model="newForm.hisMulaiJam" class="w-full" /><x-now-button wire:click="setJamSekarang('hisMulaiJam')" /></div></div>
                                    <div><x-input-label value="Ketuban pecah — Tgl" /><div class="flex gap-1 mt-1"><x-text-input type="date" wire:model="newForm.ketubanTgl" class="w-full" /><x-now-button wire:click="setTglSekarang('ketubanTgl')" /></div></div>
                                    <div><x-input-label value="Jam" /><div class="flex gap-1 mt-1"><x-text-input type="time" wire:model="newForm.ketubanJam" class="w-full" /><x-now-button wire:click="setJamSekarang('ketubanJam')" /></div></div>
                                    <div><x-input-label value="Darah/lendir — Tgl" /><div class="flex gap-1 mt-1"><x-text-input type="date" wire:model="newForm.keluarDarahTgl" class="w-full" /><x-now-button wire:click="setTglSekarang('keluarDarahTgl')" /></div></div>
                                    <div><x-input-label value="Jam" /><div class="flex gap-1 mt-1"><x-text-input type="time" wire:model="newForm.keluarDarahJam" class="w-full" /><x-now-button wire:click="setJamSekarang('keluarDarahJam')" /></div></div>
                                    <div><x-input-label value="Rasa mengejan — Tgl" /><div class="flex gap-1 mt-1"><x-text-input type="date" wire:model="newForm.rasaMengejanTgl" class="w-full" /><x-now-button wire:click="setTglSekarang('rasaMengejanTgl')" /></div></div>
                                    <div><x-input-label value="Jam" /><div class="flex gap-1 mt-1"><x-text-input type="time" wire:model="newForm.rasaMengejanJam" class="w-full" /><x-now-button wire:click="setJamSekarang('rasaMengejanJam')" /></div></div>
                                </div>
                                <div>
