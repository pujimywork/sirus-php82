...
new class extends Component {
    ...
    public function mount(?string $riHdrNo = null, bool $disabled = false): void
    {
        ...
        $this->registerAreas(['modal-laporan-anestesi-ri']);
    ...
    {
        $this->dispatch('close-modal', name: "rm-laporan-anestesi-ri-{$this->riHdrNo}");
    }
    ...
    public function cetak(string $createdAt)
    {
        ...
        try {
            ...
            return response()->streamDownload(fn() => print $pdf->output(), 'laporan-anestesi-ri-' . ($pasien['regNo'] ?? $this->riHdrNo) . '.pdf');
        } catch (\Throwable $e) {
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div class="flex-1 space-y-3">
                <div class="flex items-center gap-2">
                    <h3 class="text-base font-semibold text-ink dark:text-gray-200">Laporan Anestesi</h3>
                    @if ($laCount > 0) <x-badge variant="success">{{ $laCount }} laporan</x-badge>
            ...
            <div class="flex-1 px-4 py-4 bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                    ...
                    <div class="p-6 space-y-6 bg-canvas border border-hairline shadow-sm sm:p-8 rounded-2xl dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <section class="pt-6 space-y-4 border-t border-hairline dark:border-gray-700">
                            <h3 class="text-base font-semibold text-ink dark:text-gray-200">Tanda Tangan Ahli Anestesiologi</h3>
                            <div class="max-w-md">
                                    ...
                                    @if (!$isFormLocked)
                                        <div class="flex items-center justify-center p-6 border-2 border-gray-300 border-dashed rounded-xl dark:border-gray-700">
                                            <x-primary-button wire:click.prevent="setTtd" wire:loading.attr="disabled" wire:target="setTtd" class="gap-2">
                                                <span wire:loading.remove wire:target="setTtd">TTD Ahli Anestesiologi</span>
