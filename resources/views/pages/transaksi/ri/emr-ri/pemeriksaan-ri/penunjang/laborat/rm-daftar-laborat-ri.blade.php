...
<div>
    <table class="w-full text-sm text-left text-muted table-auto">
        <thead class="text-xs text-body uppercase bg-surface-soft">
            <tr>
                <th class="px-4 py-3 text-xs font-medium text-muted uppercase dark:text-gray-400">Tgl Lab</th>
                <th class="px-4 py-3 text-xs font-medium text-muted uppercase dark:text-gray-400">Pemeriksaan Lab</th>
