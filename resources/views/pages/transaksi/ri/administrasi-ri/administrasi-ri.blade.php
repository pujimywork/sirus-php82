...
new class extends Component {
    ...
    /* Buka Log Aktivitas — dispatch ke komponen log-aktivitas-ri yang sudah
       di-mount sibling di halaman daftar-ri (tidak mount ulang). */
    public function openLogAktivitas(string $riHdrNo): void
    {
        $this->dispatch('emr-ri.log-aktivitas.open', riHdrNo: $riHdrNo);
    }
};
?>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="grid flex-1 grid-cols-4 gap-1.5 md:grid-cols-7 min-w-0">
                                @foreach ([
                                    ...
                                    // Dijabarkan (lihat kasir-ri): dua tarif berbeda di master —
                                    // par_id=2 "ADMIN STATUS RI" & par_id=3 "ADMIN USIA 14+".
