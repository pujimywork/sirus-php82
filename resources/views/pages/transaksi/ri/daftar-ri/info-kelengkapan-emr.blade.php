        ...
        <div class="flex flex-col min-h-[calc(100vh-4rem)]">
            ...
            <div class="flex-1 px-6 py-5 space-y-5 overflow-y-auto">
                ...
                @if ($riHdrNo)
                    ...
                    @php
                        $sectionStyles = [
                            's' => ['bg' => 'bg-blue-50 dark:bg-blue-900/20', 'badge' => 'text-blue-700 bg-blue-100 dark:bg-blue-900/40 dark:text-blue-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null],
                            'o' => ['bg' => 'bg-emerald-50 dark:bg-emerald-900/20', 'badge' => 'text-emerald-700 bg-emerald-100 dark:bg-emerald-900/40 dark:text-emerald-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null],
                            'a' => ['bg' => 'bg-amber-50 dark:bg-amber-900/20', 'badge' => 'text-amber-700 bg-amber-100 dark:bg-amber-900/40 dark:text-amber-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null],
                            'p' => ['bg' => 'bg-orange-50 dark:bg-orange-900/20', 'badge' => 'text-orange-700 bg-orange-100 dark:bg-orange-900/40 dark:text-orange-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null],
                            'n' => ['bg' => 'bg-purple-50 dark:bg-purple-900/20', 'badge' => 'text-purple-700 bg-purple-100 dark:bg-purple-900/40 dark:text-purple-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null],
                    ...
                    @foreach ($checklist as $key => $section)
                        @php
                            $style = $sectionStyles[$key] ?? ['bg' => 'bg-gray-50 dark:bg-gray-900/20', 'badge' => 'text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-300', 'border' => 'border border-gray-200 dark:border-gray-700', 'caption' => null];
                            ...
                            <div class="flex items-center justify-between px-4 py-2 {{ $style['bg'] }}">
                                <div class="flex items-center gap-2">
                                    ...
                                    @if (!empty($style['caption']))
                                        <span class="text-xs font-medium {{ $style['captionClass'] ?? 'text-gray-500' }}">({{ $style['caption'] }})</span>
                                    @endif
