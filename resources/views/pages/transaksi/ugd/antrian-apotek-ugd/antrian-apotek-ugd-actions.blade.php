...
new class extends Component {
    ...
    {
        $this->dispatch('close-modal', name: 'telaah-apotek-ugd');
        $this->resetForm();
    }
                        ...
                        @if (isset($dataDaftarUGD['telaahResep']))
                            ...
                            @if (!empty($dataDaftarUGD['eresep']) || !empty($dataDaftarUGD['eresepRacikan']))
                                <div
                                    ...
                                    <p class="text-xs font-semibold text-blue-700 dark:text-blue-300 mb-1.5">Daftar
                                        Obat dalam Resep</p>
                                    <div class="space-y-1">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
                                @foreach ($dataDaftarUGD['telaahResep'] as $key => $field)
                                    ...
                                    @endif
                                    <div
                                        class="p-3 bg-surface-soft rounded-xl dark:bg-gray-800/50 border border-hairline-soft dark:border-gray-700">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="shrink-0">
                                                <x-toggle
                                                    wire:model.live="dataDaftarUGD.telaahResep.{{ $key }}.{{ $key }}"
                            ...
                            @endif
                        @else
                            <div class="py-8 text-center text-muted-soft">Memuat data telaah resep...</div>
                        @endif
                    </div>
                            ...
                            @else
                                <div class="flex items-center gap-1.5 text-xs text-emerald-700 dark:text-emerald-300">
                                    ...
                                    <span>
                                        ...
                                        pada
                                        {{ $dataDaftarUGD['telaahResep']['penanggungJawab']['userLogDate'] }}
                                    </span>
                                </div>
                            @endif
                        </div>
                ...
                <div class="flex flex-col">
                    ...
                    <div class="px-6 py-4 overflow-y-auto max-h-[60vh]">
                        @if (isset($dataDaftarUGD['telaahObat']))
                                ...
                                @foreach ($dataDaftarUGD['telaahObat'] as $key => $field)
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="shrink-0">
                                                <x-toggle
                                                    wire:model.live="dataDaftarUGD.telaahObat.{{ $key }}.{{ $key }}"
                            ...
                            @endif
                        @else
                            <div class="py-8 text-center text-muted-soft">Memuat data telaah obat...</div>
                        @endif
                    </div>
                            ...
                            @else
                                <div class="flex items-center gap-1.5 text-xs text-blue-700 dark:text-blue-300">
                                    ...
                                    <span>
                                        ...
                                        pada
                                        {{ $dataDaftarUGD['telaahObat']['penanggungJawab']['userLogDate'] }}
                                    </span>
                                </div>
                            @endif
                        </div>
