<?php
// resources/views/pages/transaksi/ugd/idrg/kirim-grouping-idrg.blade.php
// Step 4: Grouping → Final → Re-edit iDRG + Import ke INACBG — UGD
...
new class extends Component {
    ...
    #[On('idrg-grouping-ugd.import-inacbg')]
