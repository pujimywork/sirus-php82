<?php
// resources/views/pages/transaksi/ugd/satu-sehat/kirim-lab.blade.php
// Step 7: Kirim Penunjang Lab UGD — ServiceRequest → Specimen → Observation → DiagnosticReport.
// BEDA RJ: lbtxn_checkuphdrs.status_rjri = 'UGD'. Item tanpa LOINC (lbmst_clabitems.loinc_code) di-skip.
...
new class extends Component {
    use EmrUGDTrait, ServiceRequestTrait, SpecimenTrait, ObservationTrait, DiagnosticReportTrait;
