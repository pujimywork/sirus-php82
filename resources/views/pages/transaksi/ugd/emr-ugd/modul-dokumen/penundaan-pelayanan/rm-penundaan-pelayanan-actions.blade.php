...
new class extends Component {
    ...
    /* ===============================
     | SIMPAN ENTRI BARU
     =============================== */
    #[On('save-rm-penundaan-pelayanan-ugd')]
    public function addEntry(): void
    {
        ...
        try {
            DB::transaction(function () use ($entry) {
                ...
                $data['penundaanPelayananUGD'][] = $entry;

                $this->updateJsonUGD($this->rjNo, $data);
                $this->dataDaftarUGD = $data;
                $this->penundaanList = $data['penundaanPelayananUGD'];
                $this->appendAdminLogUGD((int) $this->rjNo, 'Tambah Pemberitahuan Penundaan/Kelambatan — TTD ' . ($entry['signatureDate'] ?? '-'), 'MR');
            });
...
<div>
    ...
    {{-- Cetak component --}}
    <livewire:pages::components.modul-dokumen.u-g-d.penundaan-pelayanan.cetak-penundaan-pelayanan
