<?php
// resources/views/pages/transaksi/ugd/emr-ugd/pemeriksaan/penunjang/radiologi/rm-daftar-radiologi-ugd.blade.php
...
new class extends Component {
    /*
     | Daftar Radiologi untuk satu UGD — query langsung ke DB
     | (rstxn_ugdrads JOIN rsmst_radiologis WHERE rj_no=rjNo).
    ...
    public function rows()
    {
        ...
        $items = DB::table('rstxn_ugdrads as r')
