<?php
// resources/views/pages/transaksi/ugd/emr-ugd/pemeriksaan/penunjang/laborat/rm-laborat-luar-ugd-actions.blade.php
...
new class extends Component {
    use WithRenderVersioningTrait, EmrUGDTrait;
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: "lab-luar-order-ugd-{$this->rjNo}");
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: "lab-luar-order-ugd-{$this->rjNo}");
        $this->resetForm();
    }
...
<div>
    ...
    <x-modal name="lab-luar-order-ugd-{{ $rjNo }}" size="2xl" focusable>
