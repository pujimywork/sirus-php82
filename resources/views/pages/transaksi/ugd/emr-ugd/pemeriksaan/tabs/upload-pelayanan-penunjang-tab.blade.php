{{-- pages/transaksi/ugd/emr-ugd/pemeriksaan/tabs/upload-pelayanan-penunjang-tab.blade.php --}}
<div class="space-y-4">
    ...
    @role(['Perawat', 'Admin'])
        <div class="p-4 bg-canvas border border-hairline rounded-xl shadow-sm dark:bg-gray-900 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div><x-input-error :messages="$errors->get('filePDF')" class="mt-1" /></div>
                <div><x-input-error :messages="$errors->get('descPDF')" class="mt-1" /></div>
                <div></div>
            </div>
        </div>
    @endrole
            ...
            <div class="relative px-6 py-5 border-b border-hairline dark:border-gray-700 shrink-0">
                ...
                <div class="relative flex items-start justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="font-semibold text-2xl text-ink dark:text-gray-100">Hasil Penunjang</h2>
