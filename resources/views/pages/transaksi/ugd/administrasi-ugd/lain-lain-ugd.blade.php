<?php
// resources/views/pages/transaksi/ugd/administrasi-ugd/lain-lain-ugd.blade.php
...
new class extends Component {
    ...
    protected array $renderAreas = ['modal-lainlain-ugd'];
...
<div class="space-y-4" wire:key="{{ $this->renderKey('modal-lainlain-ugd', [$rjNo ?? 'new']) }}">
