<?php
// resources/views/pages/transaksi/ugd/administrasi-ugd/jasa-dokter-ugd.blade.php
...
new class extends Component {
    ...
    protected array $renderAreas = ['modal-jasa-dokter-ugd'];
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-hairline-soft dark:divide-gray-800">
                    @forelse ($ugdJasaDokter as $item)
                        <tr wire:key="jasa-dokter-ugd-{{ $item['rjaccdocDtl'] ?? $loop->index }}" class="transition group hover:bg-surface-soft dark:hover:bg-gray-800/40">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ $isFormLocked ? 4 : 5 }}"
                                class="px-4 py-10 text-sm text-center text-muted-soft dark:text-gray-600">Belum ada jasa
                                dokter</td>
                        </tr>
                    @endforelse
                </tbody>
