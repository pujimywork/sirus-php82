...
new class extends Component {
    ...
    private function autoBuildFromKasir(array $dataRJ): void
    {
        ...
        $this->claimData['dpjp_dr_id'] = (string) ($dataRJ['drId'] ?? '');
    ...
    /* ===============================
     ...
     =============================== */
    #[On('lov.selected.dokter-dpjp-idrg-rj')]
    ...
    #[On('lov.cleared.dokter-dpjp-idrg-rj')]
    ...
    public function set(string $rjNo): void
    {
        try {
            ...
            // Kalau kosong, fallback auto dari rjhdrs.dr_id (DPJP Daftar RJ).
            ...
            if ($namaDokter === '') {
                $this->dispatch('toast', type: 'error', message: 'DPJP kosong di Daftar RJ. Pilih dokter dulu, atau ketik manual nama dokter di form.');
                return;
            }
            ...
            // (tglLahir ada & lebih dari 1 hari sebelum tgl_masuk).
            if ($umurTahunForm === 0 && $umurHariForm === 0) {
            ...
            // harus isi manual atau lengkapi data RJ dulu.
            if (empty($this->claimData['tgl_masuk'])) {
                $this->dispatch('toast', type: 'error', message: 'Tanggal Masuk kosong — rjDate tidak ter-parse / belum ada di rstxn_rjhdrs. Cek tgl registrasi atau isi manual field "Tgl Masuk" di form Set Data Klaim.');
                return;
            }
            if (empty($this->claimData['tgl_pulang'])) {
                $this->dispatch('toast', type: 'error', message: 'Tanggal Pulang kosong — rjDate tidak ter-parse / belum ada di rstxn_rjhdrs. Cek tgl registrasi atau isi manual field "Tgl Pulang" di form Set Data Klaim.');
                return;
            }
    ...
    <fieldset class="p-3 border border-hairline rounded-lg dark:border-gray-700" @disabled($idrgFinal)>
        ...
        <div class="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div class="md:col-span-3 lg:col-span-5">
                <livewire:lov.dokter.lov-dokter target="dokter-dpjp-idrg-rj" label="DPJP (Nama Dokter)"
