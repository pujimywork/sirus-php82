...
new class extends Component {
    ...
    public function openScreening(int $rjNo): void
    {
        ...
        if (!isset($this->dataDaftarPoliRJ['screening']) || !is_array($this->dataDaftarPoliRJ['screening'])) {
            $this->dataDaftarPoliRJ['screening'] = $this->getDefaultScreeningRJ();
        }
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->incrementVersion('modal-screening-rj');
            // Refresh tabel Daftar RJ & Pelayanan RJ (badge keputusan skrining ikut update).
    ...
    <x-modal name="rm-screening-rj-actions" size="full" height="full" focusable>
                ...
                @if (isset($dataDaftarPoliRJ['screening']))
                    ...
                    @php
                        ...
                        $keputusanRj = !$adaIsian
                            ? null
                            : ($skorMaksRj >= 2 ? 'IGD' : ($skorMaksRj === 1 ? 'Disegerakan' : 'Aman'));
                    @endphp
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="col-span-2">
                            <x-border-form :title="__('Kriteria Skrining')" :align="__('start')" :bgcolor="__('bg-canvas')"
                                class="h-full">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-muted -mt-0.5 mb-1">mis. perdarahan hebat, kejang, nyeri hebat,
                                        lemas mendadak</p>
                                    <div class="flex flex-wrap items-center gap-2 mt-1">
                                        ...
                                        @if ($gawatLain === 'Ya')
                                            <x-text-input type="text"
                                                ...
                                                placeholder="Sebutkan tanda gawat yang ditemukan..." :disabled="$isFormLocked"
                                                :error="$errors->has('dataDaftarPoliRJ.screening.gawatLainKet')"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-muted -mt-0.5 mb-1">mis. kursi roda, brankar, tongkat, dipapah
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-muted -mt-0.5 mb-1">batuk &gt; 2 minggu → flag infeksius (tidak
                        ...
                        <div class="col-span-1">
                            <x-border-form :title="__('Hasil Keputusan')" :align="__('start')" :bgcolor="__('bg-canvas')"
                                class="h-full">
        ...
        'IGD' => ['bg' => 'bg-red-500', 'ring' => 'ring-red-400', 'desc' => 'Rujuk IGD'],
                                        ...
                                        <div
                                            ...
                                            <span class="font-normal text-[10px] opacity-90">{{ $info['desc'] }}</span>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                @if ($keputusanRj)
                                    <div
                                        ...
                                        {{ match ($keputusanRj) {
                                            ...
                                            default => 'bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-300',
                                        } }}">
