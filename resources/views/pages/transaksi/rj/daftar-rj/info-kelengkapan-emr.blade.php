            ...
            <div class="flex-1 px-6 py-5 space-y-5 overflow-y-auto">
                ...
                @if ($rjNo)
                    ...
                    @foreach ($checklist as $key => $section)
                        @php
                            $style = $sectionStyles[$key] ?? ['bg' => 'bg-surface-soft dark:bg-gray-900/20', 'badge' => 'text-body bg-surface-soft dark:bg-gray-700 dark:text-gray-300'];
                ...
                <div class="p-3 border border-hairline rounded-lg bg-surface-soft dark:bg-gray-900/40 dark:border-gray-700">
                    ...
                    <div class="flex flex-wrap items-center gap-4 text-sm">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-body dark:text-gray-300">&lt; 50% — kurang</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="inline-block w-4 h-2 rounded bg-amber-400/80 dark:bg-amber-400"></span>
                            <span class="text-body dark:text-gray-300">50–79% — sedang</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="inline-block w-4 h-2 rounded bg-emerald-500/80 dark:bg-emerald-400"></span>
                            <span class="text-body dark:text-gray-300">≥ 80% — lengkap</span>
                        </div>
                    </div>
                </div>
