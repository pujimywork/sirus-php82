                    ...
                    <table class="min-w-full text-sm border-collapse">
                        <thead class="bg-surface-card dark:bg-gray-800 text-body dark:text-gray-200">
                            <tr class="text-xs font-semibold tracking-wider uppercase">
                                ...
                                <th class="px-2 py-3 text-center w-20 border border-hairline dark:border-gray-700">No Kegiatan</th>
                            ...
                            @foreach ($this->rows as $i => $r)
                                ...
                                @if ($showGroupHeader)
                                    <tr class="bg-surface-soft dark:bg-gray-800/40">
                                        <td colspan="4" class="px-3 py-1.5 text-[11px] font-semibold tracking-wider uppercase text-muted dark:text-gray-300 border-y border-hairline dark:border-gray-700">
                                            {{ $r['grup'] }}
                                        </td>
                                    </tr>
                                @endif
                                ...
                                <tr class="{{ $isCatchAll ? 'bg-amber-50/60 dark:bg-amber-900/15 font-semibold' : 'hover:bg-surface-soft dark:hover:bg-gray-800/50' }} border-b border-hairline-soft dark:border-gray-800">
                                    ...
                                    <td class="px-2 py-2 border-r border-hairline dark:border-gray-700 text-center font-mono text-muted">{{ $r['id'] }}</td>
                        ...
                        <tfoot class="bg-surface-soft dark:bg-gray-800 border-t-2 border-gray-300 dark:border-gray-600 font-bold">
                            <tr class="text-sm text-ink dark:text-gray-100">
                                <td colspan="3" class="px-3 py-3 border border-hairline dark:border-gray-700">TOTAL</td>
                                <td class="px-3 py-3 text-right tabular-nums border border-hairline dark:border-gray-700">{{ number_format($this->totalJumlah) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
