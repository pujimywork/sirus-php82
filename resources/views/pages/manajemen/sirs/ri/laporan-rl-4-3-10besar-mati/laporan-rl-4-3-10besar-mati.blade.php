                    ...
                    <table class="min-w-full text-sm border-collapse">
                        <thead class="bg-surface-card dark:bg-gray-800 text-body dark:text-gray-200">
                            <tr class="text-xs font-semibold tracking-wider uppercase">
                                ...
                                <th colspan="3" class="px-2 py-3 text-center border border-hairline dark:border-gray-700 text-rose-700 dark:text-rose-300">Pasien Keluar Mati (sort key)</th>
                            </tr>
                            <tr class="text-xs font-semibold tracking-wider uppercase">
                        ...
                        <tbody>
                            @forelse ($this->rows as $i => $r)
                                <tr class="hover:bg-surface-soft dark:hover:bg-gray-800/50 border-b border-hairline-soft dark:border-gray-800">
                                    ...
                                    <td class="px-2 py-2 border-r border-hairline dark:border-gray-700 text-right tabular-nums text-emerald-700 dark:text-emerald-300">{{ number_format($r['total']) }}</td>
                            ...
                            @empty
                                <tr><td colspan="9" class="px-6 py-10 text-center text-muted dark:text-gray-400 italic">Tidak ada pasien RI meninggal di tahun {{ $tahun }}</td></tr>
                            @endforelse
                        </tbody>
