                    ...
                    <table class="min-w-full text-sm border-collapse">
                        <thead class="bg-surface-card dark:bg-gray-800 text-body dark:text-gray-200">
                            <tr class="text-xs font-semibold tracking-wider uppercase">
                                <th class="px-2 py-3 text-center w-16 border border-hairline dark:border-gray-700">No.</th>
                                <th class="px-3 py-3 text-left border border-hairline dark:border-gray-700">Jenis Kegiatan</th>
                                <th class="px-3 py-3 text-right border border-hairline dark:border-gray-700 text-blue-700 dark:text-blue-300">Laki-Laki</th>
                                <th class="px-3 py-3 text-right border border-hairline dark:border-gray-700 text-pink-700 dark:text-pink-300">Perempuan</th>
                                <th class="px-3 py-3 text-right border border-hairline dark:border-gray-700">Jumlah</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($this->rows as $r)
                                ...
                                <tr class="{{ $isCatchAll ? 'bg-amber-50/60 dark:bg-amber-900/15 font-semibold' : 'hover:bg-surface-soft dark:hover:bg-gray-800/50' }} border-b border-hairline-soft dark:border-gray-800">
                                    ...
                                    <td class="px-3 py-2 border-r border-hairline dark:border-gray-700 text-right tabular-nums text-blue-700 dark:text-blue-300">{{ number_format($r['laki']) }}</td>
                                    <td class="px-3 py-2 border-r border-hairline dark:border-gray-700 text-right tabular-nums text-pink-700 dark:text-pink-300">{{ number_format($r['perempuan']) }}</td>
                        ...
                        <tfoot class="bg-surface-soft dark:bg-gray-800 border-t-2 border-gray-300 dark:border-gray-600 font-bold">
                            <tr class="text-sm text-ink dark:text-gray-100">
                                <td colspan="2" class="px-3 py-3 border border-hairline dark:border-gray-700">TOTAL</td>
                                <td class="px-3 py-3 text-right tabular-nums border border-hairline dark:border-gray-700 text-blue-800 dark:text-blue-200">{{ number_format($tot['laki']) }}</td>
                                <td class="px-3 py-3 text-right tabular-nums border border-hairline dark:border-gray-700 text-pink-800 dark:text-pink-200">{{ number_format($tot['perempuan']) }}</td>
                                <td class="px-3 py-3 text-right tabular-nums border border-hairline dark:border-gray-700">{{ number_format($tot['jumlah']) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
