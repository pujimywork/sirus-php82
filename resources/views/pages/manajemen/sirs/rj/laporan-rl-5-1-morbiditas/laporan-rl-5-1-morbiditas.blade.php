...
use Carbon\Carbon;
use App\Http\Traits\Manajemen\RL51Trait;
        ...
        <div class="w-full px-4 py-2 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold leading-tight text-gray-900 dark:text-gray-100">
                    Laporan RL 5.1 &mdash; Morbiditas Pasien Rawat Jalan
                </h2>
                <p class="text-base text-gray-700 dark:text-gray-700">
                    Rekap morbiditas RJ poliklinik per ICD-10 × umur × gender per tahun.
                    <span class="text-gray-400">"Kasus Baru" = pasien unik per ICD per tahun (DISTINCT reg_no).
                    "Jumlah Kunjungan" = total visits. 1 pasien dengan multiple visit ICD-yang-sama → tetap 1 kasus baru.</span>
                </p>
            </div>
                ...
                <div class="overflow-x-auto max-h-[700px] overflow-y-auto">
                    <table class="text-[10px] border-collapse">
                        <thead class="sticky top-0 z-30 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                            ...
                            <tr>
                                @foreach (App\Http\Traits\Manajemen\RL51Trait::AGE_GROUPS_RL51 as $ag)
