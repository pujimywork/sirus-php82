            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('keuangan.penerimaan-kas-tu') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Penerimaan Kas TU</div>
                    ...
                    <a href="{{ route('keuangan.pengeluaran-kas-tu') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Pengeluaran Kas TU</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                    ...
                    <a href="{{ route('keuangan.saldo-kas') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Saldo Kas</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('keuangan.pembayaran-hutang-pbf') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Pembayaran Hutang PBF</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                    ...
                    <a href="{{ route('keuangan.pembayaran-hutang-non-medis') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Pembayaran Hutang Non-Medis</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                    ...
                    <a href="{{ route('keuangan.topup-supplier-pbf') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Setor DP Supplier PBF</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                    ...
                    <a href="{{ route('keuangan.topup-supplier-non-medis') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Setor DP Supplier Non-Medis</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('gudang.kartu-stock-non') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Kartu Stock Non-Medis</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
