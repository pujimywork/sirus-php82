...
<div>
    <header class="bg-white shadow dark:bg-gray-800">
        <div class="w-full px-4 py-2 sm:px-6 lg:px-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Rekap permintaan lab dari RJ, UGD, dan RI &mdash; <span class="font-medium">Tahunan</span>
    ...
    <div class="w-full min-h-[calc(100vh-5rem-72px)] bg-white dark:bg-gray-800">
        <div class="px-6 pt-2 pb-6">
            ...
            @if ($mode === 'bulanan')
                <livewire:pages::manajemen.lab.laporan-permintaan-lab.laporan-permintaan-lab-bulanan wire:key="laporan-permintaan-lab-bulanan" />
            @else
                <livewire:pages::manajemen.lab.laporan-permintaan-lab.laporan-permintaan-lab-tahunan wire:key="laporan-permintaan-lab-tahunan" />
            @endif
