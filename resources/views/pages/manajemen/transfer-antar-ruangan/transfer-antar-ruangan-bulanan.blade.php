...
<div>
    ...
    <div class="mt-4 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                ...
                <span class="ml-2 font-normal text-xs text-gray-500">{{ count($this->lokasiBreakdown) }} rute</span>
            </h3>
        </div>
    ...
    <div class="mt-4 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                Breakdown per Barang
                <span class="ml-2 font-normal text-xs text-gray-500">{{ count($this->barangBreakdown) }} item · sort by nilai (HPP)</span>
            </h3>
            <div class="text-xs text-gray-500 dark:text-gray-400">
