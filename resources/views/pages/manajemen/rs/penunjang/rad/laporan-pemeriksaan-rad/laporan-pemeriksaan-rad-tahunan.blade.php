...
<div>
    ...
    <div class="mt-4 bg-canvas border border-hairline shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-hairline dark:border-gray-700">
            <h3 class="text-sm font-semibold text-body dark:text-gray-200">Tren Pemeriksaan Radiologi <span class="ml-2 font-normal text-xs text-muted">(per tahun, {{ $tahunMin }}&ndash;{{ $tahunMax }})</span></h3>
        </div>
