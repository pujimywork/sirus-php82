...
new class extends Component {
    ...
    public function rows(): array
    {
        ...
        $aggregate = $this->buildPemeriksaanRadAggregate($start, $end, "to_char(h.rj_date, 'YYYY')", "to_char(h.exit_date, 'YYYY')");
...
<div>
    @php
        ...
        $chartKey = md5("pemeriksaan-rad-tahunan-{$tahunFrom}-{$tahunTo}");
    @endphp
        ...
        <button type="button" @click="open = !open"
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                    Ringkasan Pemeriksaan Radiologi {{ $tahunMin }}&ndash;{{ $tahunMax }}
    ...
    <div class="mt-4 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">Tren Pemeriksaan Radiologi <span class="ml-2 font-normal text-xs text-gray-500">(per tahun, {{ $tahunMin }}&ndash;{{ $tahunMax }})</span></h3>
        </div>
