...
<div>
    ...
    <div class="mt-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-700 dark:bg-gray-900" x-data="{ open: false }">
        <button type="button" @click="open = !open"
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-gray-700 dark:text-gray-200">Ringkasan Pemeriksaan Radiologi {{ $filterTahun }}</div>
    ...
    <div class="mt-4 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">Tren Pemeriksaan Radiologi <span class="ml-2 font-normal text-xs text-gray-500">(per bulan, tahun {{ $filterTahun }})</span></h3>
        </div>
    ...
    <div class="mt-4 bg-white border border-gray-200 shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                ...
                <span class="ml-2 font-normal text-xs text-gray-500">(periode terpilih, gabungan RJ/UGD/RI)</span>
            </h3>
        </div>
                ...
                <tbody>
                    @forelse ($this->topItem as $i => $it)
                        ...
                        <tr class="border-t border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            ...
                            <td class="px-3 py-2.5 font-medium text-gray-800 dark:text-gray-100">{{ $it->item_name ?? "(ID: {$it->rad_id})" }}</td>
