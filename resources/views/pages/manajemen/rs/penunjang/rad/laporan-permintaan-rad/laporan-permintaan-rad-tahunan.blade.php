...
new class extends Component {
    ...
    public function rows(): array
    {
        ...
        $aggregate = $this->buildPermintaanRadAggregate($start, $end, "to_char(h.rj_date, 'YYYY')", "to_char(h.exit_date, 'YYYY')");
        ...
        for ($y = $from; $y <= $to; $y++) {
            $key = (string) $y;
            $result[] = $this->fillPermintaanRow($byPeriode, $key, $key);
        }
        return $result;
    }
...
<div>
    @php
        ...
        $chartKey = md5("rad-tahunan-{$tahunFrom}-{$tahunTo}");
    @endphp
        ...
        <button type="button" @click="open = !open"
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-gray-700 dark:text-gray-200">
                    Ringkasan Permintaan Radiologi {{ $tahunMin }}&ndash;{{ $tahunMax }}
