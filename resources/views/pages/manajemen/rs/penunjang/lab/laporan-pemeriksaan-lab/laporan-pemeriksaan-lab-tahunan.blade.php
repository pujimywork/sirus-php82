...
<div>
    ...
    <div class="mt-4 bg-canvas border border-hairline shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-hairline dark:border-gray-700">
            <h3 class="text-sm font-semibold text-body dark:text-gray-200">Tren Pemeriksaan Lab <span class="ml-2 font-normal text-xs text-muted">(per tahun, {{ $tahunMin }}&ndash;{{ $tahunMax }})</span></h3>
        </div>
    ...
    <div class="mt-4 bg-canvas border border-hairline shadow-sm rounded-2xl dark:border-gray-700 dark:bg-gray-900">
        <div class="px-4 py-3 border-b border-hairline dark:border-gray-700">
            <h3 class="text-sm font-semibold text-body dark:text-gray-200">
                ...
                <span class="ml-2 font-normal text-xs text-muted">(periode terpilih, billable items only)</span>
            </h3>
        </div>
                ...
                <tbody>
                    @forelse ($this->topItem as $i => $it)
                        ...
                        <tr class="border-t border-hairline-soft dark:border-gray-800 hover:bg-surface-soft dark:hover:bg-gray-800/50">
                            ...
                            <td class="px-3 py-2.5 font-medium text-ink dark:text-gray-100">{{ $it->item_name ?? "(ID: {$it->clabitem_id})" }}</td>
