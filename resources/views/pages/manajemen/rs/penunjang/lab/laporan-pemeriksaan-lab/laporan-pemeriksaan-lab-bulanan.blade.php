...
use Carbon\Carbon;
use App\Http\Traits\Manajemen\PemeriksaanLabTrait;
    ...
    <div class="mt-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-700 dark:bg-gray-900" x-data="{ open: false }">
        <button type="button" @click="open = !open"
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-gray-700 dark:text-gray-200">Ringkasan Pemeriksaan Lab {{ $filterTahun }}</div>
