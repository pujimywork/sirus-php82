...
new class extends Component {
    ...
    public function rows(): array
    {
        ...
        $aggregate = $this->buildPemeriksaanLabAggregate($start, $end, "to_char(h.checkup_date, 'MM')");
...
<div>
    @php
        $tot = $this->totals;
        $chartKey = md5("pemeriksaan-lab-bulanan-{$filterTahun}");
    @endphp
    ...
    <div class="mt-4 bg-canvas border border-hairline rounded-2xl dark:border-gray-700 dark:bg-gray-900" x-data="{ open: false }">
        <button type="button" @click="open = !open"
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-body dark:text-gray-200">Ringkasan Pemeriksaan Lab {{ $filterTahun }}</div>
