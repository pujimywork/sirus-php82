...
<div>
    ...
    <div class="mt-4 bg-white border border-gray-200 rounded-2xl dark:border-gray-700 dark:bg-gray-900"
        ...
        <button type="button" @click="open = !open"
            ...
            <svg class="w-4 h-4 text-gray-400 transition-transform duration-200 shrink-0" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div x-cloak x-show="open" class="px-4 pb-4 border-t border-gray-200 dark:border-gray-700"
            ...
            <div class="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-7">
                <div class="p-3 bg-brand-green/5 border border-brand-green/30 rounded-xl dark:border-brand-lime/30 dark:bg-brand-lime/5">
                    ...
                    <div class="mt-0.5 text-[10px] text-gray-500 dark:text-gray-400 truncate" title="Januari–Desember {{ $filterTahun }}">Januari&ndash;Desember {{ $filterTahun }}</div>
                </div>
