...
<div>
    ...
    <div class="w-full min-h-[calc(100vh-5rem-72px)] bg-white dark:bg-gray-800">
        <div class="px-6 pt-2 pb-6">
            ...
            {{-- CHILD CONTENT --}}
            @if ($mode === 'bulanan')
                <livewire:pages::manajemen.rs.ugd.laporan-kunjungan-ugd.laporan-kunjungan-ugd-bulanan wire:key="laporan-kunjungan-ugd-bulanan" />
            @else
                <livewire:pages::manajemen.rs.ugd.laporan-kunjungan-ugd.laporan-kunjungan-ugd-tahunan wire:key="laporan-kunjungan-ugd-tahunan" />
            @endif
