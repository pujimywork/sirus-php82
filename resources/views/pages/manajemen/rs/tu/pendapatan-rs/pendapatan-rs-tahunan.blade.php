            ...
            <tbody>
                @foreach ($this->rows as $row)
                    <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        ...
                        <td class="px-3 py-2 text-right font-mono text-gray-500 border-r border-gray-200 dark:border-gray-700">{{ number_format($row['ugd_umum'], 0, ',', '.') }}</td>
                        <td class="px-3 py-2 text-right font-mono">{{ number_format($row['ri_bpjs'], 0, ',', '.') }}</td>
                        <td class="px-3 py-2 text-right font-mono text-gray-500 border-r border-gray-200 dark:border-gray-700">{{ number_format($row['ri_umum'], 0, ',', '.') }}</td>
                        <td class="px-3 py-2 text-right font-mono font-semibold text-emerald-700 dark:text-emerald-300">{{ number_format($row['bpjs'], 0, ',', '.') }}</td>
                        <td class="px-3 py-2 text-right font-mono font-semibold text-amber-700 dark:text-amber-300 border-r border-gray-200 dark:border-gray-700">{{ number_format($row['umum'], 0, ',', '.') }}</td>
