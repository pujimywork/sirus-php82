...
use Carbon\Carbon;
use App\Http\Traits\Manajemen\RL33Trait;
        ...
        <div class="w-full px-4 py-2 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold leading-tight text-gray-900 dark:text-gray-100">
                    Laporan RL 3.3 &mdash; Rawat Darurat
                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Rekap UGD/IGD per <span class="font-medium">jenis pelayanan</span> per bulan,
                    sesuai format SIRS Online Kemenkes.
                    <span class="text-gray-400">Mapping otomatis: poli DPJP &amp; umur pasien &rarr; 13 jenis pelayanan
                    (Bayi/Anak/Geriatri/Kebidanan/Psikiatrik/Non bedah lainnya). Kategori Kecelakaan &amp; Kekerasan
                    butuh ICD diagnosis matching, ditangguhkan.</span>
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div class="flex items-end">
                        <div class="text-xs text-gray-500 dark:text-gray-400 leading-snug">
                            ...
                            <br>
                            <span class="text-[10px] text-gray-400">Filter pakai rj_date di rstxn_ugdhdrs.</span>
                        </div>
                    </div>
                </div>
            </div>
