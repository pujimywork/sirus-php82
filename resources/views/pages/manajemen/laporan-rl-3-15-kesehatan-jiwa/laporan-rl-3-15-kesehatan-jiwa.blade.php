...
use Carbon\Carbon;
use App\Http\Traits\Manajemen\RL315Trait;
        ...
        <div class="w-full px-4 py-2 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold leading-tight text-gray-900 dark:text-gray-100">
                    Laporan RL 3.15 &mdash; Kesehatan Jiwa
                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Rekap pelayanan kesehatan jiwa rawat jalan per tahun, sesuai format SIRS Online Kemenkes
                    (8 jenis kegiatan + 1 fallback).
                    <span class="text-gray-400">Source: kunjungan POLI PSIKIATRI di RJ. UGD/RI tidak termasuk
                    (RL 3.15 spesifik untuk pelayanan rawat jalan).</span>
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div class="sm:col-span-2 flex items-end">
                        <div class="text-xs text-gray-500 dark:text-gray-400 leading-snug">
                            Periode aktif: <span class="font-semibold text-gray-700 dark:text-gray-200">Januari &ndash; Desember {{ $tahun }}</span><br>
                            <span class="text-[10px] text-gray-400">RL 3.15 dilaporkan tahunan ke SIRS Online.</span>
                        </div>
                    </div>
                </div>
            </div>
