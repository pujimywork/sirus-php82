...
<div>
    ...
    <div class="w-full min-h-[calc(100vh-5rem-72px)] bg-white dark:bg-gray-800">
        <div class="px-6 pt-2 pb-6">
            ...
            {{-- CHILD CONTENT --}}
            @if ($mode === 'bulanan')
                <livewire:pages::manajemen.rj.laporan-kunjungan-rj.laporan-kunjungan-rj-bulanan wire:key="laporan-kunjungan-rj-bulanan" />
            @else
                <livewire:pages::manajemen.rj.laporan-kunjungan-rj.laporan-kunjungan-rj-tahunan wire:key="laporan-kunjungan-rj-tahunan" />
            @endif
