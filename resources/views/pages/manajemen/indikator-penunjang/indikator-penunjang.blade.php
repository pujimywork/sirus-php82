    ...
    <header class="bg-white shadow dark:bg-gray-800">
        <div class="w-full px-4 py-2 sm:px-6 lg:px-8">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Oversight Laboratorium, Radiologi & Apotek &mdash; Supervisor Penunjang / Manager Umum
            </p>
        </div>
    </header>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('manajemen.mutasi-obat') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-gray-800 dark:text-gray-100">Mutasi Obat</div>
                            <div class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <a href="{{ route('gudang.kartu-stock') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-gray-800 dark:text-gray-100">Kartu Stock Gudang Medis</div>
                            <div class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <a href="{{ route('gudang.kartu-stock-apt') }}" wire:navigate
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-gray-800 dark:text-gray-100">Kartu Stock Apotek</div>
                            <div class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
