    ...
    <div class="w-full min-h-screen px-4 pt-4 pb-2"
        ...
        <div class="h-[calc(100vh-220px)] overflow-auto"
                        ...
                        <tbody class="bg-white">
                            @forelse ($rowsAntri as $row)
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="px-3 py-2.5 font-semibold text-gray-900 truncate">
                                        {{ $row->reg_name }}
                                    </td>
                                    <td class="px-3 py-2.5 truncate">
                                        <span class="text-xs text-gray-500">{{ $row->dr_name }}</span><br>
                                        {{ $row->poli_desc }}
                                    </td>
            ...
            @if ($rowsAntri->count() === 0 && $rowsLunas->count() === 0)
                <div class="w-full p-6 text-center text-sm text-gray-500">Belum ada antrian resep hari ini.</div>
            @endif
