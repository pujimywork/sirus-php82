    ...
    <div class="w-full h-[calc(100vh-5rem)] flex flex-col bg-surface-soft dark:bg-gray-800">
        <div class="flex flex-col flex-1 min-h-0 px-6 pt-0 pb-6">
            ...
            <x-confirm-button variant="danger" action="deleteFiltered" title="Hapus Log Terfilter"
                                ...
                                {{-- Idle: teks normal --}}
                                <span wire:loading.remove wire:target="deleteFiltered" class="inline-flex items-center gap-1.5">
                                ...
                                {{-- Proses: spinner + "Menghapus..." (kayak Simpan) --}}
                                <span wire:loading wire:target="deleteFiltered" class="inline-flex items-center gap-1.5">
                                    <x-loading size="xs" /> Menghapus...
                                </span>
                            </x-confirm-button>
                        </div>
                    @endif
