            ...
            <div
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 ml-auto">
                        ...
                        {{-- Cek Status
                             → x-ghost-button: aksi tersier toolbar/filter,
                               tidak mengubah data, hanya refresh state --}}
                        ...
                        {{-- Mount Share
                             → x-primary-button: aksi utama positif,
                               "menghubungkan" = konfirmasi/aktifkan --}}
                        ...
                        {{-- Unmount Share
                             → x-warning-button: perubahan status (disconnect/nonaktifkan),
                               bukan destruktif permanen — data di share tidak hilang --}}
